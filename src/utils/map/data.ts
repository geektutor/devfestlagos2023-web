...
export const MAP: Partial<Record<Room, Array<Room>>> = {
  [LOCATIONS.EXHIBITION]: [LOCATIONS.ROOM_1, LOCATIONS.ROOM_3],
  [LOCATIONS.ROOM_1]: [LOCATIONS.EXHIBITION, LOCATIONS.ROOM_2, LOCATIONS.ENTRANCE],
  [LOCATIONS.ROOM_2]: [LOCATIONS.ROOM_1, LOCATIONS.EXIT, LOCATIONS.HALLWAY, LOCATIONS.ROOM_3],
  [LOCATIONS.ROOM_3]: [LOCATIONS.EXHIBITION, LOCATIONS.ROOM_2],
  [LOCATIONS.ROOM_4]: [LOCATIONS.STAIRS],
  [LOCATIONS.STAIRS]: [LOCATIONS.HALLWAY, LOCATIONS.ROOM_4],
