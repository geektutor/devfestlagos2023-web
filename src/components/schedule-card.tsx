...
export const ScheduleCard = () => {
  return (
    <div className='scc'>
      ...
      <div className='scc__text_content'>
        <h4 className='scc__text_content__title'>🍽️ WTM + WW Breakfast / Registration</h4>
        <div className='scc__text_content__footer'>
          <div className='scc__text_content__footer__time'>9:00 AM - 10:00 AM</div>
          <div className='scc__text_content__footer__venue'>
            <svg
          ...
          <div className='scc__text_content__footer__view'>
            View Description
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='24'
